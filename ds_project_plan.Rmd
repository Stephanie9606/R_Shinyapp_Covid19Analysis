...
* Overall Layout (1)
    + For a first tab, we may use a US map to be a basic visual of the dashboard to show any input that the user selects.     + For a second tab, we may use a table to show the analysis in details(table and/or plot)
