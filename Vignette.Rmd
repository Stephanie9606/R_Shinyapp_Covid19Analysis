...
2. Forth Tab: Ranking
- Inputs and Control: Users can choose which data they are interested in. They can click radio button for getting the Us density maps and spreadsheets, which reflecting `The Number of Confirmed Cases`, `The Number of Death Cases`, `Recovery Rate`, and `Death Rate`.
- Outputs: In this tab, users can see the subset data with its density maps. At the same time, users can read the entire spreadsheet that contained the important information of Covid-19 by geography. In the spreadsheet, users can see the rank of confirmed cases and death cases by State as well.
